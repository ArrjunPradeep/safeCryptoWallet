...
const functionDataDecoding = async(abi, data) => {

  const iface = new ethers.utils.Interface(abi);

  const transaction = iface.parseTransaction({data});

  const method = transaction.functionFragment.name;
